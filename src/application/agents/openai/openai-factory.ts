...
export class OpenAIFactory implements AgentFactory {
    readonly models: AgentModel[] = [
        ...
        },
        {
            ...
            model: 'gpt-5-pro',
            alias: 'gpt-5-pro',
            description: 'GPT-5 Pro with extended reasoning for Pro subscribers'
        },
        {
            provider: 'openai',
            model: 'gpt-4.5',
            alias: 'gpt-4.5',
            description: 'Advanced model with better understanding and creativity (deprecated July 2025)'
        },
        {
            provider: 'openai',
            model: 'gpt-4.1',
        ...
        },
        {
            ...
            model: 'gpt-4.1-mini',
            alias: 'gpt-4.1-mini',
            description: 'Fast, capable, and efficient small model with 1M context'
        },
        {
            provider: 'openai',
            model: 'gpt-4.1-nano',
            alias: 'gpt-4.1-nano',
            description: 'Fastest and cheapest model with 1M token context window'
        },
        {
            provider: 'openai',
            model: 'o4-mini',
            alias: 'o4-mini',
            description: 'Latest reasoning model optimized for fast, cost-efficient reasoning'
        },
        {
            provider: 'openai',
            model: 'o3',
            alias: 'o3',
            description: 'Powerful reasoning model pushing frontier across coding, math, and science'
        },
        {
            provider: 'openai',
            model: 'o3-pro',
            alias: 'o3-pro',
            description: 'o3 Pro version available for Pro users with enhanced capabilities'
        },
        {
            provider: 'openai',
            model: 'gpt-4o',
