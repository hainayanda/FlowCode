...
export class AzureFactory implements AgentFactory {
    readonly models: AgentModel[] = [
        ...
        },
        {
            ...
            model: 'o4-mini',
            alias: 'azure-o4-mini',
            description: 'o4-mini reasoning model via Azure OpenAI with 200K context'
        },
        {
            provider: 'azure',
            model: 'o3',
            alias: 'azure-o3',
            description: 'o3 reasoning model via Azure OpenAI with 200K context'
        },
        {
            provider: 'azure',
            model: 'o3-mini',
            alias: 'azure-o3-mini',
            description: 'o3-mini reasoning model via Azure OpenAI with 200K context'
        },
        {
            provider: 'azure',
            model: 'gpt-4o',
