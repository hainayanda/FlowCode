...
/**
 * Factory for creating Qwen agent workers.
 *
...
export class QwenFactory implements AgentFactory {
     ...
     *
     * Includes Qwen2.5 Max (latest MoE), various parameter sizes (72B to 7B),
     * and specialized models for vision, audio, and turbo performance.
     */
    readonly models: AgentModel[] = [
        {
            ...
            alias: 'qwen-max',
            description:
                'Latest Qwen2.5-Max MoE model with 20T+ training tokens and RLHF (2025)',
        },
        {
            provider: 'qwen',
            model: 'qwen2.5-turbo',
            ...
            description:
                'Qwen2.5 Turbo model for fast and efficient processing',
        },
        {
            provider: 'qwen',
            model: 'qwen2.5-plus',
        ...
        },
        {
            ...
            alias: 'qwen-2.5-72b',
            description:
                'Qwen2.5 72B parameter model for complex reasoning tasks',
        },
        {
            provider: 'qwen',
    ...
    /**
     * Creates a new Qwen agent worker instance.
     *
     * @param name - Unique identifier for the worker instance
     * @param config - Configuration settings for the Qwen model
     * @param toolbox - Optional toolbox providing additional capabilities to the agent
     * @returns Configured QwenWorker instance ready for use
     */
    createWorker(
        name: string,
