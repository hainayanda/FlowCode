...
import { GeminiAgent } from '../../../../src/application/agents/google/gemini-agent.js';
...
describe('GeminiAgent', () => {
  ...
  describe('validateConfig', () => {
    ...
    it('should return false for invalid base config', async () => {
      const invalidConfig = { ...createGeminiConfig(), apiKey: '' };
      const invalidAgent = new GeminiAgent(invalidConfig, toolbox);
