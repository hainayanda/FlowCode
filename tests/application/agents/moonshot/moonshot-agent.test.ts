...
import { MoonshotAgent } from '../../../../src/application/agents/moonshot/moonshot-agent.js';
...
describe('MoonshotAgent', () => {
  let agent: MoonshotAgent;
  ...
  beforeEach(async () => {
    ...
    agent = new MoonshotAgent(createMoonshotConfig(), toolbox);
  });

  describe('constructor', () => {
    it('should initialize with Moonshot client', async () => {
      const OpenAI = vi.mocked(await import('openai')).default;
  ...
  describe('processStream', () => {
    ...
    it('should pass correct parameters to Moonshot API', async () => {
  ...
  describe('validateConfig', () => {
    ...
    it('should return false for invalid base config', async () => {
      const invalidConfig = { ...createMoonshotConfig(), apiKey: '' };
      const invalidAgent = new MoonshotAgent(invalidConfig, toolbox);
  ...
  describe('getProvider', () => {
    it('should return moonshot provider', () => {
