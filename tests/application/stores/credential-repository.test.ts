...
describe('CredentialRepository', () => {
  ...
  describe('getCredentials', () => {
    it('should read and parse credentials file', async () => {
      ...
      const result = await credentialRepository.getCredentials();
    ...
    it('should throw error when file read fails', async () => {
      ...
      await expect(credentialRepository.getCredentials()).rejects.toThrow('Failed to read credentials file: File not found');
    });

    it('should throw error when JSON parsing fails', async () => {
      mockFs.readFile.mockResolvedValue('invalid json');

      await expect(credentialRepository.getCredentials()).rejects.toThrow('Failed to read credentials file:');
    });
  });
  ...
  describe('getProviderCredential', () => {
    it('should return credential for existing provider', async () => {
      ...
      const result = await credentialRepository.getProviderCredential('openai');
    ...
    it('should return null for non-existing provider', async () => {
      ...
      const result = await credentialRepository.getProviderCredential('nonexistent');
  ...
  describe('getAllProviders', () => {
    it('should return all provider names', async () => {
      ...
      const result = await credentialRepository.getAllProviders();
  ...
  describe('hasCredential', () => {
    it('should return true for existing provider', async () => {
      ...
      const result = await credentialRepository.hasCredential('openai');
    ...
    it('should return false for non-existing provider', async () => {
      ...
      const result = await credentialRepository.hasCredential('nonexistent');
  ...
  describe('credentialsExist', () => {
    it('should return true when file exists', async () => {
      ...
      const result = await credentialRepository.credentialsExist();
  ...
  describe('getCredentialsPath', () => {
    it('should return credentials file path', () => {
      const result = credentialRepository.getCredentialsPath();
  ...
  describe('writeCredentials', () => {
    it('should write credentials to file', async () => {
      ...
      await credentialRepository.writeCredentials(mockCredentials);
    ...
    it('should throw error when write fails', async () => {
      ...
      await expect(credentialRepository.writeCredentials(mockCredentials)).rejects.toThrow('Failed to write credentials file: Write error');
    });
  });
  ...
  describe('setProviderCredential', () => {
    it('should set credential for new provider', async () => {
      ...
      await credentialRepository.setProviderCredential('google', newCredential);
    ...
    it('should update existing provider credential', async () => {
      ...
      await credentialRepository.setProviderCredential('openai', updatedCredential);
  ...
  describe('updateLastUsed', () => {
    it('should update lastUsed timestamp for existing provider', async () => {
      ...
      await credentialRepository.updateLastUsed('openai');
    ...
    it('should throw error for non-existing provider', async () => {
      ...
      await expect(credentialRepository.updateLastUsed('nonexistent')).rejects.toThrow("Provider 'nonexistent' not found in credentials");
    });
  });
  ...
  describe('removeProviderCredential', () => {
    it('should remove provider credential', async () => {
      ...
      await credentialRepository.removeProviderCredential('openai');
  ...
  describe('ensureCredentialsDirectory', () => {
    it('should create credentials directory', async () => {
      ...
      await credentialRepository.ensureCredentialsDirectory();
    ...
    it('should throw error when directory creation fails', async () => {
      ...
      await expect(credentialRepository.ensureCredentialsDirectory()).rejects.toThrow('Failed to create credentials directory: Permission denied');
    });
  });
});